...
/**
 * binary_tree_balance - Tp measures balance factor of a binary tree
 * @tree: The tree to go through
 ...
 * Return: 0 if it is not a perfect or other number that is the level of height
 */
 ...
 * @tree: The tree to check
 * Return: 1 if it is a Heap or 0 if not
 */
