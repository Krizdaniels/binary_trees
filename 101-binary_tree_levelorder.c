...
/**
 * binary_tree_height - The function that measures height of a binary tree
...
/**
 * linked_node - Function makes a linked list from depth level and node
...
/**
 * recursion - It goes through the complete tree and stores each node
