...
/**
 * r_insert_node - The node value instertion in a AVL.
 * @tree: The type **pointer of root node of the AVL tree struct.
 * @parent: The parent node of struct AVL.
 * @new: The type**pointer left or right insertion.
 * @nval: The insertion value of the AVL.
 * Return: The pointer to new root after insertion otherwise NULL
 */
 ...
 * @tree: The type **pointer to root node of AVL tree to insert into.
